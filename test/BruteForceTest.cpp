...
//TEST(BruteForceTSPTest, tsp_13) {
//    AdjacencyMatrix graph(13);
//    graph.setEdge(0, 1, 29);
//    graph.setEdge(0, 2, 82);
//    graph.setEdge(0, 3, 46);
//    graph.setEdge(0, 4, 68);
...
//    graph.setEdge(11, 9, 21);
//    graph.setEdge(11, 10, 65);
//    graph.setEdge(11, 12, 61);
//
//    graph.setEdge(12, 0, 23);
//    graph.setEdge(12, 1, 11);
//    graph.setEdge(12, 2, 64);
//    graph.setEdge(12, 3, 51);
//    graph.setEdge(12, 4, 46);
//    graph.setEdge(12, 5, 51);
//    graph.setEdge(12, 6, 51);
//    graph.setEdge(12, 7, 33);
//    graph.setEdge(12, 8, 29);
//    graph.setEdge(12, 9, 41);
//    graph.setEdge(12, 10, 42);
//    graph.setEdge(12, 11, 61);
//
//    BruteForce tsp;
//    tsp.solve(graph);
//
//    ASSERT_EQ(1, tsp.getShortestPathLength());
//    ASSERT_EQ("", tsp.toString());
//}
