...
TEST(DynamicTSPTest, shouldFindShortestPathFromMatrixCaseOne) {
...
TEST(DynamicTSPTest, shouldFindShortestPathFromUndMatrixCaseOne) {
    AdjacencyMatrix graph(6);
    graph.setEdge(0, 1, 5);
    graph.setEdge(1, 0, 5);
...
TEST(DynamicTSPTest, shouldFindShortestPathFromUndirectedMatrixRandomCaseOne) {
