...
plt.plot(d_matrix_20[:,0], d_matrix_20[:,3], label='Kruskal - macierz')
plt.scatter(d_matrix_20[:,0], d_matrix_20[:,3])
plt.plot(d_list_20[:,0], d_list_20[:,3], label='Kruskal - lista')
plt.scatter(d_list_20[:,0], d_list_20[:,3])
plt.plot(b_matrix_20[:,0], b_matrix_20[:,3], label='Prim - macierz')
plt.scatter(b_matrix_20[:,0], b_matrix_20[:,3])
plt.plot(b_list_20[:,0], b_list_20[:,3], label='Prim - lista')
plt.scatter(b_list_20[:,0], b_list_20[:,3])
plt.legend()
plt.title("Gęstość = 20%")
plt.ylabel('czas [s]')
plt.xlabel('Liczba wierzchołków')
plt.savefig("20densMST.png", dpi=800)
plt.clf()

plt.plot(d_matrix_60[:,0], d_matrix_60[:,3], label='Kruskal - macierz')
plt.scatter(d_matrix_60[:,0], d_matrix_60[:,3])
plt.plot(d_list_60[:,0], d_list_60[:,3], label='Kruskal - lista')
plt.scatter(d_list_60[:,0], d_list_60[:,3])
plt.plot(b_matrix_60[:,0], b_matrix_60[:,3], label='Prim - macierz')
plt.scatter(b_matrix_60[:,0], b_matrix_60[:,3])
plt.plot(b_list_60[:,0], b_list_60[:,3], label='Prim - lista')
plt.scatter(b_list_60[:,0], b_list_60[:,3])
plt.legend()
plt.title("Gęstość = 60%")
plt.ylabel('czas [s]')
plt.xlabel('Liczba wierzchołków')
plt.savefig("60densMST.png", dpi=800)
plt.clf()


plt.plot(d_matrix_99[:,0], d_matrix_99[:,3], label='Kruskal - macierz')
plt.scatter(d_matrix_99[:,0], d_matrix_99[:,3])
plt.plot(d_list_99[:,0], d_list_99[:,3], label='Kruskal - lista')
plt.scatter(d_list_99[:,0], d_list_99[:,3])
plt.plot(b_matrix_99[:,0], b_matrix_99[:,3], label='Prim - macierz')
plt.scatter(b_matrix_99[:,0], b_matrix_99[:,3])
plt.plot(b_list_99[:,0], b_list_99[:,3], label='Prim - lista')
plt.scatter(b_list_99[:,0], b_list_99[:,3])
plt.legend()
plt.title("Gęstość = 99%")
plt.ylabel('czas [s]')
plt.xlabel('Liczba wierzchołków')
plt.savefig("99densMST.png", dpi=800)
plt.clf()
